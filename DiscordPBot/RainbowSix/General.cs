...
namespace DiscordPBot.RainbowSix
{
    public class General
    {
        ...
        [JsonProperty("barricades_deployed")] public int BarricadesDeployed { get; set; }

        [JsonProperty("blind_kills")] public int BlindKills { get; set; }

        [JsonProperty("bullets_fired")] public int BulletsFired { get; set; }

        [JsonProperty("bullets_hit")] public int BulletsHit { get; set; }

        [JsonProperty("dbnos")] public int Dbnos { get; set; }

        [JsonProperty("deaths")] public int Deaths { get; set; }

        [JsonProperty("distance_travelled")] public int DistanceTravelled { get; set; }

        [JsonProperty("gadgets_destroyed")] public int GadgetsDestroyed { get; set; }
        ...
        [JsonProperty("penetration_kills")] public int PenetrationKills { get; set; }

        [JsonProperty("playtime")] public int Playtime { get; set; }

        [JsonProperty("rappel_breaches")] public int RappelBreaches { get; set; }
        ...
        [JsonProperty("suicides")] public int Suicides { get; set; }
